...
public class RawJdbcRepository {
    ...
    public void printHintSimpleSelect() throws SQLException {
        ...
        try (HintManager hintManager = HintManager.getInstance(); Connection conn = dataSource.getConnection(); PreparedStatement preparedStatement = conn.prepareStatement(sql)) {
